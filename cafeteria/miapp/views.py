...
from .mixins import PermissionProtectedTemplateView , CRUDMixin
...
class testView(CRUDMixin,PermissionProtectedTemplateView):
    model = Cafe
    form_class = CafeForm
    ...
    context_object_name = 'cafes'
    success_url = 'test'  # Nombre de la URL de redirección
    permission_required = 'cafeteria.can_edit_menu'  # Permiso requerido
    order_by = 'nombre'